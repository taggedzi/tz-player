...
This folder contains lightweight project documentation.
...
- `SPEC.md` for product and behavior requirements
- `AGENTS.md` for agent implementation rules
- `THIRD_PARTY_LICENSES.md` for third-party license inventory
