...
- Tasks:
  ...
  - `DOC-001D` Document persistence/state/config services including schema assumptions and migration-sensitive behavior. Status: `in_progress` (`state_store`, `db/schema`, and `paths` documented; remaining persistence/config files pending)
